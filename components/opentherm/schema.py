...
SENSORS: dict[str, SensorSchema] = {
    ...
    # HVAC Sensors
    "rel_vent_setpoint": SensorSchema(
        description="Relative ventilation setpoint",
        unit_of_measurement=UNIT_PERCENT,
        accuracy_decimals=2,
        icon="mdi:fan-percent",
        state_class=STATE_CLASS_MEASUREMENT,
        message="REL_VENT_SETPOINT",
        keep_updated=True,
        message_data="u8_lb",
    ),
    "rel_ventilation": SensorSchema(
        description="Relative ventilation",
        unit_of_measurement=UNIT_PERCENT,
        accuracy_decimals=2,
        icon="mdi:fan-percent",
        state_class=STATE_CLASS_MEASUREMENT,
        message="REL_VENTILATION",
        keep_updated=True,
        message_data="u8_lb",
    ),
    "rel_humid_exhaust": SensorSchema(
        description="Relative humidity exhaust",
        unit_of_measurement=UNIT_PERCENT,
        accuracy_decimals=0,
        icon="mdi:water-percent",
        state_class=STATE_CLASS_MEASUREMENT,
        message="REL_HUMID_EXHAUST",
        keep_updated=True,
        message_data="u8_lb",
    ),
    "exhaust_co2": SensorSchema(
        description="Exhaust CO2 level",
    ...
    "supply_inlet_temp": SensorSchema(
        description="Supply inlet temperature",
        unit_of_measurement=UNIT_CELSIUS,
        accuracy_decimals=2,
        device_class=DEVICE_CLASS_TEMPERATURE,
        state_class=STATE_CLASS_MEASUREMENT,
        message="SUPPLY_INLET_TEMP",
        keep_updated=True,
        message_data="f88",
    ),
    "supply_outlet_temp": SensorSchema(
        description="Supply outlet temperature",
        unit_of_measurement=UNIT_CELSIUS,
        accuracy_decimals=2,
        device_class=DEVICE_CLASS_TEMPERATURE,
        state_class=STATE_CLASS_MEASUREMENT,
        message="SUPPLY_OUTLET_TEMP",
        keep_updated=True,
        message_data="f88",
    ),
    "exhaust_inlet_temp": SensorSchema(
        description="Exhaust inlet temperature",
        unit_of_measurement=UNIT_CELSIUS,
        accuracy_decimals=2,
        device_class=DEVICE_CLASS_TEMPERATURE,
        state_class=STATE_CLASS_MEASUREMENT,
        message="EXHAUST_INLET_TEMP",
        keep_updated=True,
        message_data="f88",
    ),
    "exhaust_outlet_temp": SensorSchema(
        description="Exhaust outlet temperature",
        unit_of_measurement=UNIT_CELSIUS,
        accuracy_decimals=2,
        device_class=DEVICE_CLASS_TEMPERATURE,
        state_class=STATE_CLASS_MEASUREMENT,
        message="EXHAUST_OUTLET_TEMP",
        keep_updated=True,
        message_data="f88",
    ),
    "exhaust_fan_speed": SensorSchema(
        ...
        device_class=DEVICE_CLASS_EMPTY,
        state_class=STATE_CLASS_MEASUREMENT,
        message="EXHAUST_FAN_SPEED",
        keep_updated=True,
        message_data="u16",
    ),
    "supply_fan_speed": SensorSchema(
        ...
        device_class=DEVICE_CLASS_EMPTY,
        state_class=STATE_CLASS_MEASUREMENT,
        message="SUPPLY_FAN_SPEED",
        keep_updated=True,
        message_data="u16",
    ),
    "nom_rel_ventilation": SensorSchema(
        description="Nominal relative ventilation",
        unit_of_measurement=UNIT_PERCENT,
        accuracy_decimals=0,
        icon="mdi:fan-percent",
        state_class=STATE_CLASS_MEASUREMENT,
        message="NOM_REL_VENTILATION",
        keep_updated=False,
        message_data="u8_lb",
    ),
}
...
BINARY_SENSORS: dict[str, BinarySensorSchema] = {
    ...
    # HVAC Status
    "hvac_fault_indication": BinarySensorSchema(
        description="HVAC: Fault indication",
        device_class=DEVICE_CLASS_PROBLEM,
    ...
    "hvac_device_mode_0": BinarySensorSchema(
        description="HVAC: Device mode status bit 0",
        message="HVAC_STATUS",
        keep_updated=True,
        message_data="flag8_lb_1",
    ),
    "hvac_device_mode_1": BinarySensorSchema(
        description="HVAC: Device mode status bit 1",
        message="HVAC_STATUS",
        keep_updated=True,
        message_data="flag8_lb_2",
    ),
    "hvac_device_mode_2": BinarySensorSchema(
        description="HVAC: Device mode status bit 2",
        message="HVAC_STATUS",
        keep_updated=True,
        message_data="flag8_lb_3",
    ),
    "hvac_device_status_0": BinarySensorSchema(
        description="HVAC: Device status bit 0",
        message="HVAC_STATUS",
        keep_updated=True,
        message_data="flag8_lb_4",
    ),
    "hvac_device_status_1": BinarySensorSchema(
        description="HVAC: Device status bit 1",
        message="HVAC_STATUS",
        keep_updated=True,
        message_data="flag8_lb_5",
    ),
